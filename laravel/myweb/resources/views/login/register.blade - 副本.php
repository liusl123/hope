...

{
...

	{
		...
		$.ajax({
			...
			data:"account="+email+"&pwd="+pwdcode+"&code="+emailcode+"&isAgree="+isAgree+"&from=Web_VIVOAccount&locale=zh_CN",
			...
			<div class="left">
				...
				<ul class="phoneregister cl" id="phone-reg">
							<li class="vercode li_input">
								<em></em>
								<input class="v_inp" type="text" name="code" placeholder="请输入图片验证码" id="_phoneiconcode" 
							...
							<li class="phonenumber li_input">
								...
								<input class="v_inp" type="text" autocomplete="off" placeholder="请输入手机号" id="_phonenum" name="phonenum"
								name="account" id="_phonenum" onfocus="inputFocus('_phonenum')" onblur="checkPhoneOnline()"/>
				...
				<!-- 邮箱注册 -->
						<ul class="emailregister cl" id="email-reg">
							<li class="email li_input">
								<em></em>
								<input class="v_inp" type="text" placeholder="请输入邮箱地址" id="_email"
							...
							<li class="psw li_input">
								<em></em>
								<input class="v_inp" type="password" placeholder="请输入密码" id="_emailpwd" 
							...
							<li class="vercode li_input">
								<em></em>
								<input class="v_inp" type="text" placeholder="请输入验证码" id="_emailcode" 
