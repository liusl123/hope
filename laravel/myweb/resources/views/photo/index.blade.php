                    ...
                    <div class="mws-panel-body no-padding">
                       ...
                       <table class="mws-datatable-fn mws-table dataTable" id="DataTables_Table_1" aria-describedby="DataTables_Table_1_info">
                            <thead>
                                <tr role="row">
	                                ...
	                                <th class="sorting" role="columnheader" tabindex="0" aria-controls="DataTables_Table_1" rowspan="1" colspan="1" aria-label="Browser: activate to sort column ascending" style="width: 208px;">类别</th>
                       ...
                       <tbody role="alert" aria-live="polite" aria-relevant="all">
                       	...
                       	@endif
	                        <td class=" ">{{$v['id']}}</td>
	                        @for($i=1;$i<6;$i++)
	                       	<td class=" "> <img src='{{$v["photo".$i]}}' alt=''></td>
	                       	 @endfor
	                        <td class=" ">{{$v['cate']}}</td>
	                        <td>
	                        	<a href="/admin/photo/del/{{$v['id']}}" class='icon-trash' style="font-size:20px;color:yellowgreen"></a>
	                        	&nbsp;&nbsp;
	                        	<a href="/admin/photo/edit/{{$v['id']}}" class='icon-wrench' style="font-size:20px;color:yellowgreen"></a>
	                        </td>
                        </tr>
