...
<meta content="text/html; charset=UTF-8" http-equiv="Content-Type">
    ...
    <link rel="shortcut icon" href="/ho/grzx/favicon_7761e1f.ico">
...
<link media="all" href="/ho/grzx/index.css" type="text/css" rel="stylesheet">
</head>
...
<header id="header">
    <div class="head-search">
        <div class="search-box">
        	<form action="" method="get">
                <input autocomplete="off" name="searchKeywordStr" maxlength="20" placeholder="如:x9" value="" type="text">
    ...
    <div class="wrapper">
        <nav id="navigator" class="cl">
        	<a href="" class="vivo-logo"><img src="/ho/grzx/vivo-logo_865fdf1.png" alt="vivo智能手机官方网站"></a>
            <ul class="cl">
                <li><a href="">手机</a></li>
                <li><a href="">配件</a></li>
                <li><a href="">V币商品</a></li>
                <li><a href="">服务</a></li>
                <li><a href="" target="_top">社区</a></li>
                <li><a href="" target="_top">官网</a></li>
            </ul>
            <div class="search-user">
                <ul class="top-quick-menu">
                    ...
                    <li id="j_UserMenuTrigger">
                    	<a href="http://www.lamp169.com/grzx" class="user"><b><img src="/ho/grzx/small"></b></a>
                        <ul class="user-menu">
                        	<li class="member-center"><a href="http://www.lamp169.com/grzx"><i></i>个人中心</a><span class="icon-angular"></span></li>
                            <li class="my-order"><a href="http://www.lamp169.com/order"><i></i>我的订单</a></li>
                            <li class="logout"><a href="http://www.lamp169.com/logout"><i></i>退出登录</a></li>
                        </ul>
                    </li>
                    <li><a href="http://www.lamp169" class="shoppingcart"><b></b><span class="shopcart-num">0</span></a></li>
                </ul>
            </div>
        </nav>
    </div>
...
<div class="wrapper">
    <div class="crumbs">您的位置：<a href="http://www.lamp169.com/index.html">首页</a><b></b>会员中心</div>
</div>
<div class="wrapper">
<aside class="menu-bar">
    <ul class="portrait-box">
        <li>
            <a href="http://www.lamp169.com/grzx/information" title="编辑资料">
            <img src="/ho/grzx/big" width="160">
            </a>
        </li>
        <li class="mem-name member-menu-nickName"><i class="icon-mem"></i>{{--session('')['']--}}</li>
        <li class="vcoin-info">我的V币：<a href="http://www.lamp169.com/grzx/vcoin"><span class="red member-vcoin-number">0</span></a> V币</li>
    </ul>
    <dl id="j_MyCenterMenus" class="menu">
        <dt class="menu-title"><i class="icon-deal"></i>交易管理</dt>
        <dd class="menu-item"><a href="http://shop.vivo.com.cn/my/order">我的订单</a></dd>
        ...
        <dd class="menu-item"><a href="http://shop.vivo.com.cn/my/information">个人资料</a></dd>
        <dd class="menu-item"><a href="http://shop.vivo.com.cn/my/address">收货地址</a></dd>
...
<dl>
    <dd class="module-item mem-overview">
        <h1 class="welcome-info">您好，<span class="name">123玩家</span>，欢迎进入会员中心！</h1>
        <ul class="mem-properties">
            <li>我的V币：<a href="http://www.lamp169.com/grzx/vcoin"><span class="red my-vcoin-number">0</span>V币</a></li>
            <li><a href="http://shop.vivo.com.cn/my/vcoin">查看V币历史 &gt;</a></li>
            <li class="login-time">
                最近一次登录时间：2017-02-07 21:23</li>
        </ul>
        <div class="statistic-list">
            <ul>
                ...
                <li class="item coupon">优惠券<a href="http://shop.vivo.com.cn/my/coupon">1</a></li>
            </ul>
        </div>

        <div class="page-module">
            <h2 class="title">最近的订单</h2>
                <div class="no-record no-order special"><img src="/ho/grzx/no-order-icon_3030d23.png"><span>您还没有订单</span>
                </div>
        </div>
        <div class="page-module">
            <h2 class="title">最近浏览</h2>
            <div class="no-record no-browse-record special" colspan="5"><img src="/ho/grzx/no-browse-record-icon_141eec4.png"><span>您还没有任何浏览记录</span></div>
        </div>
    </dd>
</dl>
    </article>
        ...
        <div class="wrapper cl">
            ...
            <dl class="shop-help-last">
                ...
                <dd class="online-service">
                    <a target="_top" href="http://crm2.qq.com/page/portalpage/wpa.php?uin=4007161118&amp;aty=0&amp;a=0&amp;curl=&amp;ty=1"><img class="lazy" data-src="https://swsdl.vivo.com.cn/vivoshop/web/dist/img/common/online-service_1e5d0b6.png" src="/ho/grzx/online-service_1e5d0b6.png" style="display: inline;"></a>
                </dd>
            </dl>
        </div>
    </div>
