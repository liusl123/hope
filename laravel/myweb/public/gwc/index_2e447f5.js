$(function(){
    ...
    t={
        ...
        initEvent:function(){
            ...
            //     }
            // }),
            $(".J_delSingle").on("click",function(){var i=$(this).closest(".J_viewTBody"),t=i.find(".J_viewInfo").attr("data-uniqueCode"),n={uniqueCodes:t},a={dialogTitle:"提示信息",dialogContent:"确定将该商品从购物车中删除吗？",dialogConfirm:function(){var t={submitUrl:"/shoppingcart/cartDel",isAsync:!0,dealResult:function(t){if(200==t.retCode)return e.noneViewRefreshPage(1),i.remove(),e.calculateTotal(),e.refreshShopCartNumFromCookie(),void e.changAllStatus();if(t.retMsg.match("^{(.+:.+,*){1,}}$")){var n=$.parseJSON(t.retMsg);e.changeViewStatus(i,n.operate,n.tip,n.msg)}else e.changeViewStatus(i,2,null,t.retMsg)}};e.confirmSimpleAjax(n,t)}};e.confirmDialogSimple(n,a)}),$(".J_delMultiple").on("click",function(){var t=$(".J_viewCheckBox.checked");if(0==t.length)return void new Dialog({confirmBtn:!0,cancelBtn:!0,title:"至少选中一种商品",icon:"warning"});var n=[],a=[];t.each(function(){var e=$(this).attr("data-uniqueCode");n.push(e),$(this).closest(".J_viewTBody").find(".J_favorite").length>0&&a.push(i[e].mainSku.skuId)});var o={uniqueCodes:n},c={dialogTitle:"是否删除商品？",dialogConfirmText:"删除",dialogCancelText:"移入收藏夹",dialogContent:"您可以选中移到我的收藏，或删除商品",dialogConfirm:function(){var i={submitUrl:"/shoppingcart/cartDel",isAsync:!0,dealResult:function(i){if(200==i.retCode&&e.refreshPage(),i.retMsg.match("^{(.+:.+,*){1,}}$")){var t=$.parseJSON(i.retMsg);e.changeViewStatus(null,t.operate,null,t.msg)}else e.changeViewStatus(null,null,null,i.retMsg)}};e.confirmSimpleAjax(o,i)},dialogCancel:function(){if(!LoginConfirm.isLogin())return void LoginConfirm.redirect();if(a.length>0){var i={submitUrl:"/my/favorite/add",isAsync:!0,dealResult:function(){}};e.confirmSimpleAjax({goodsIds:a},i)}c.dialogConfirm()}};e.confirmDialogNormal({uniqueCodes:n},c)}),$(".J_favorite").on("click",function(){if(!LoginConfirm.isLogin())return void LoginConfirm.redirect();var t=$(this).attr("data-skuId"),n=$(".J_favorite[data-skuId="+t+"]"),a=$(this).attr("data-uniqueCode"),o={submitUrl:"/my/favorite/add",isAsync:!0,dealResult:function(){var e=new Dialog({content:"收藏成功",icon:"success"});e.show(),setTimeout(function(){e.hide()},3e3),n.replaceWith($("<span>已收藏</span>"))}};e.confirmSimpleAjax({goodsId:i[a].mainSku.skuId},o)}),$(".J_favoriteMultiple").on("click",function(){var t=$(".J_viewCheckBox.checked");if(0==t.length)return void new Dialog({confirmBtn:!0,cancelBtn:!0,title:"至少选中一种商品",icon:"warning"});if(!LoginConfirm.isLogin())return void LoginConfirm.redirect();var n=[],a=[];t.each(function(){var e=$(this).attr("data-uniqueCode");n.push(e),$(this).closest(".J_viewTBody").find(".J_favorite").length>0&&a.push(i[e].mainSku.skuId)});var o={dialogTitle:"是否移入收藏夹？",dialogContent:"移动后选中商品将不在购物车中显示",dialogConfirm:function(){if(a.length>0){var i={submitUrl:"/my/favorite/add",isAsync:!0,dealResult:function(){}};e.confirmSimpleAjax({goodsIds:a},i)}this.delConfirm()},delConfirm:function(){var i={submitUrl:"/shoppingcart/cartDel",isAsync:!0,dealResult:function(i){if(200==i.retCode&&e.refreshPage(),i.retMsg.match("^{(.+:.+,*){1,}}$")){var t=$.parseJSON(i.retMsg);e.changeViewStatus(null,t.operate,null,null)}else e.changeViewStatus(null,null,null,i.retMsg)}};e.confirmSimpleAjax({uniqueCodes:n},i)}};e.confirmDialogSimple({uniqueCodes:n},o)}),$(".J_btnConfirm").on("click",function(){var i=$(".J_viewCheckBox.checked");if(0==i.length)return void new Dialog({confirmBtn:!0,cancelBtn:!0,title:"至少选中一种商品",icon:"warning"});var t=[],n=[],a=!0,o=!0;i.each(function(){var i=$(this).closest(".J_viewTBody");n.push($(this).attr("data-uniqueCode"));var c={submitUrl:"/shoppingcart/sufficient",isAsync:!0,dealResult:function(t){if(200==t.retCode)return void e.changeViewStatus(i,0,null,null);if(t.retMsg.match("^{(.+:.+,*){1,}}$")){o=!1;var n=$.parseJSON(t.retMsg);return void e.changeViewStatus(i,n.operate,n.tip,null)}a=!1}};t.push(e.confirmSimpleAjax(e.groupConfirmParameter(i),c))}),$.when.apply(null,t).done(function(){return e.changAllStatus(),a?o?void(window.location.href=webCtx+"/order/cart/confirm?uniqueCodes="+n):void new Dialog({confirmBtn:!0,content:"温馨提示:您所选购的部分商品暂时不能购买！"}).show():void new Dialog({confirmBtn:!0,content:"温馨提示:当前服务器太忙，请稍后重试！"}).show()})})},
